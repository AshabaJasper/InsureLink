...
class AppointmentsRecord extends FirestoreRecord {
  ...
  // "appointmentPhoneNo" field.
  int? _appointmentPhoneNo;
  int get appointmentPhoneNo => _appointmentPhoneNo ?? 0;
  bool hasAppointmentPhoneNo() => _appointmentPhoneNo != null;
  ...
  void _initializeFields() {
    ...
    _appointmentPhoneNo = castToType<int>(snapshotData['appointmentPhoneNo']);
  }
...
Map<String, dynamic> createAppointmentsRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'appointmentPhoneNo': appointmentPhoneNo,
    }.withoutNulls,
  );
...
class AppointmentsRecordDocumentEquality
  ...
  bool equals(AppointmentsRecord? e1, AppointmentsRecord? e2) {
    return e1?.appointmentName == e2?.appointmentName &&
        ...
        e1?.appointmentPhoneNo == e2?.appointmentPhoneNo;
  }
