                ...
                children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 8.0, 0.0, 0.0),
                          child: Text(
                            'Fill out the information below in order to book create an insured with our office.',
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: const ['Child Visit', 'Exam Results', 'Misbehaviour'],
                      onChanged: (val) =>
