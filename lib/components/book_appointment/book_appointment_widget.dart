...
class _BookAppointmentWidgetState extends State<BookAppointmentWidget>
  ...
  void initState() {
    ...
    _model.personsNameController1 ??=
        TextEditingController(text: '[Persons name]');
    _model.personsNameFocusNode1 ??= FocusNode();

    _model.personsNameController2 ??=
        TextEditingController(text: 'Phone number');
    _model.personsNameFocusNode2 ??= FocusNode();
                          ...
                          children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 0.0),
                                    child: Text(
                                      'Fill out the information below in order to add the insured to the system',
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 0.0),
                              child: TextFormField(
                                controller: _model.personsNameController1,
                                focusNode: _model.personsNameFocusNode1,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Insuring For',
                                  labelStyle:
                                ...
                                validator: _model
                                    .personsNameController1Validator
                                    .asValidator(context),
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 0.0),
                              child: TextFormField(
                                controller: _model.personsNameController2,
                                focusNode: _model.personsNameFocusNode2,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Enter insured Phone number',
                                  labelStyle:
                                      FlutterFlowTheme.of(context).bodySmall,
                                  enabledBorder: OutlineInputBorder(
                                    borderSide: BorderSide(
                                ...
                                style: FlutterFlowTheme.of(context).titleMedium,
                                validator: _model
                                    .personsNameController2Validator
                                    .asValidator(context),
                              ).animateOnPageLoad(animationsMap[
                                    ...
                                    onPressed: () async {
                                      await AppointmentsRecord.collection
                                          ...
                                          .set(createAppointmentsRecordData(
                                            ...
                                            appointmentPhoneNo: int.tryParse(
                                                _model.personsNameController2
                                                    .text),
                                          ));
                                      context.pop();
