                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  15.0, 0.0, 0.0, 0.0),
                                          child: Image.asset(
                                            'assets/images/k6oi2uffm5ele5sfgclg6qlpma.png',
                                            width: 60.0,
                                            height: 60.0,
                                            fit: BoxFit.cover,
                                          ),
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 0.0,
                                                                0.0, 8.0),
                                                    child: AutoSizeText(
                                                      'Keep In touch with your workers and people under your insurance',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodySmall
                                    ...
                                    child: Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          await launchUrl(Uri(
                                              scheme: 'mailto',
                                              path: 'ashabajasper@gmail.com',
                                              query: {
                                                'subject':
                                                    'Set up insurance scheme ',
                                                'body':
                                                    'Please set up insurance scheme for my children as they want to study.',
                                              }
                                                  .entries
                                                        ...
                                                        padding:
                                                            const EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    8.0),
                                                        child: AutoSizeText(
                                                          'Start up an insurance plan with us',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodySmall
                                                              .override(
